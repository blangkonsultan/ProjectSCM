            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                      ...
                      <li class="active"><a href="pelanggan_checkout.php">Pembayaran</a></li>
            ...
            <div class="row">
              <form class="form-inline col-md-8 col-md-offset-2" method="post">
                <div class="form-group">
                  <input type="text" readonly value="Hello Bagas" style="border:none">
                </div>
              </form>
                  ...
                  <div class="product-content-right">
                      <div class="woocommerce">
                                  ...
                                  <tbody>
                                        <tr class="cart_item">
                                          ...
                                          <td class="product-thumbnail">
                                            <img src="upload\031220181801016.jpg">
                                          </td>
                              ...
                              <form class="col-md-9" method="post">
                                  <a href="pelanggan_pembayaran_produk.php" class="btn btn-success">Bayar</a>
                                  </form>
                          </div>
