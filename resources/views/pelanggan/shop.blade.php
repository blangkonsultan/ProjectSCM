    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="pelanggan_home">Komp<span>o</span>skan</a></h1>
                    </div>
                </div>
              ...
              <div class="col-md-3 col-sm-6">
                  <div class="single-shop-product">
                      <div class="product-upper">
                          <img src="upload\03122018070336beras-merah.jpg">
                      </div>
                      <h2>Pupuke</h2>
                      ...
                      <br>
                      <div class="container">
                      <a href="pelanggan_single_product.php" class="btn btn-primary" style="background:#1abc9c; border:none; width: 260px; margin-left:-13px"><strong>Detail</strong></a>
                      </div>
                      <!-- Modal -->
                 </div>
              </div>
