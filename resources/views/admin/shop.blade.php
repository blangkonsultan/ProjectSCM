...
<body>
  ...
  style="background-color: #818481a1 ;
   ...
   <div class="form-card" style="
    ...
    border-radius: 10px;
">
  <h3 style="color: #fefefe" >Pembelian Bahan Baku <span class="label label-default"></span></h3>
<!-- tabel data padi -->
<div class="row">
      <div class="col-md-12 ">
          <div class="container-fluid panel panel-warning table-reponsive">

              <div class="panel-heading">Bahan Baku yang Tersedia</div>
              ...
              <!--   Table -->
                ...
                <table class="table table-hover" style=" text-align: center; ">
                  <tr>
                    ...
                    <tr>
                        <td style="text-align: center;">Supardi</td>
                        <td style="text-align: center;">Kotoran Sapi</td>
                        <td style="text-align: center;">80 kg</td>
                        <td style="text-align: center;">12000</td>
                        <td>
                          <input  type="number" min="5" max="" class="form-control" name="jumlah" style="width: 90px;d">
                        </td>
                        <td><a href="#" class="btn btn-info">Beli</a></td>
                      </tr>
