...
<body>
  ...
  style="background-color: #818481a1 ;
         border-radius: 10px;
         padding-bottom: 20px;">
  <h3>Data Pemesan <span class="label label-default"></span></h3>
<!-- tabel data padi -->

<strong>Nama Pelanggan : Bagas</strong>
<p>Email  : Bagas@bagas.com<br>
   Alamat : Krian<br>
   Tanggal  : 2019-06-22<br>
   Total Pemesanan : Rp. 12000<br>
