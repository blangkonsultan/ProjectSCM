...
<body>
  ...
  border-radius: 10px;
  ">
  <h3 style="color: #fefefe">Keranjang<span class="label label-default"></span></h3>
  <!-- tabel data padi -->
  <div class="row">
    <div class="col-md-12 ">
      <div class="container-fluid panel panel-warning table-reponsive">
        ...
        <table class="table table-hover" style=" text-align: center; ">
          <tr>
            <th style="text-align: center" class="product-remove">No</th>
            <th style="text-align: center" class="product-name">Nama Produk</th>
            <th style="text-align: center" class="product-price">Harga</th>
            <th style="text-align: center" class="product-quantity">Jumlah</th>
            <th style="text-align: center" class="product-subtotal">Total</th>
            <th style="text-align: center" >Hapus</th>
            <th style="text-align: center" >Lanjutkan Pembayaran</th>
          </tr>
          <tr>
            <td >1</td>
            <td >Kotoran Sapi</td>
            ...
            <td>
              <a href="admin_pembayaran_produk.php" class="btn btn-success">Bayar</a>
            </td>
          </tr>
        </table>
      </div>
