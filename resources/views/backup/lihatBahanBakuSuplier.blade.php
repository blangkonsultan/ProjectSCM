...
<div class="row">
      <div class="col-md-12 ">
          <div class="container-fluid panel panel-warning table-reponsive">
            ...
            <input type="Name" name="nama_pupuk" class="form-control" id="nameJenisPadi" placeholder="Nama Pupuk" value="<?php echo $data ["jenis_padi"];?>">
          </div>
          <div class="form-group">
              <label for="gambar">Gambar :</label>
          <input type="file" name="gambar" class="form-control" id="gambar" placeholder="Gambar Pupuk" value="<?php echo $data ["gambar"];?>">
          </div>
            <div class="form-group">
              <label for="Jenispupuk">Jenis Pupuk :</label>
              <select class="form-control" name="Jenis_pupuk">
             <option <?php if ($data["kualitas_padi"] == 'Pupuk Hijau'): ?> selected <?php endif ?>>Pupuk Hijau</option>
            <option <?php if ($data["kualitas_padi"] == 'Pupuk Hayati'): ?> selected <?php endif ?>>Pupuk Hayati Organik</option>
            <option<?php if ($data["kualitas_padi"] == 'Pupuk Kandang'): ?> selected <?php endif ?>>Pupuk Kandang</option>
            <option<?php if ($data["kualitas_padi"] == 'Pupuk Kompos'): ?> selected <?php endif ?>>Pupuk Kompos</option>
            <option<?php if ($data["kualitas_padi"] == 'Pupuk Lainnya...'): ?> selected <?php endif ?>>Pupuk Lainnya...</option>
              </select>
            </div>
            <div class="form-group">
              <label for="Name">Stok Pupuk :</label>
              <input type="Name" name="stok_kg" class="form-control" id="stok" placeholder="/Kg" value="<?php echo $data ["stok_kg"];?>/Kg">
            </div>
            <div class="form-group">
              <label for="Tipe">Tipe :</label>
              <select class="form-control" name="Tipe" value="<?php echo $data ["warna"];?>">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" name="detail_pupuk" rows="5" id="comment"><?php echo $data ["detail_padi"];?></textarea>
            </div>
            <div class="form-group">
