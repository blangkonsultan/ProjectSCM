...
<body>
  ...
  border-radius: 10px;
  ">
  <h3 style="color: #fefefe">Riwayat Pemesanan<span class="label label-default"></span></h3>
  <!-- tabel data padi -->
  <div class="row">
    <div class="col-md-12 ">
      <div class="container-fluid panel panel-warning table-reponsive">

        <div class="panel-heading">Riwayat Pemesanan</div>
        ...
        <table class="table table-hover" style=" text-align: center; ">
          ...
          <tr>
            ...
            <td>
              <a href="admin_pembayaran_produk.php" class="btn btn-success">Pembayaran</a>
            </td>
          </tr>
        </table>
      </div>
