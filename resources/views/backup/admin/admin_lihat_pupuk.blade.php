                    ...
                    <div class="modal-body">
                      <form method="post">
                        <div class="form-group">
                          ...
                          <input type="Name" name="nama_pupuk" class="form-control" id="nameJenisPadi" placeholder="Nama Pupuk" value="Pupuke">
                        </div>
                        <div class="form-group">
                          <label for="gambar">Gambar :</label>
                          <input type="file" name="gambar" class="form-control" id="gambar" placeholder="Gambar Pupuk" value="">
                        </div>
                        <div class="form-group">
