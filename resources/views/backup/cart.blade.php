                    ...
                    <div class="product-content-right">
                        <div class="woocommerce">
                            <form method="post" >
                                      ...
                                      <?php foreach ($_SESSION['keranjang'] as $id_padi => $jumlah): ?>
                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-thumbnail" style="width:70%">
                                              <img style="width:70% ; height: auto" src="upload/<?php echo $data['gambar']; ?>">
                                            </td>
                                            ...
                                            <td>
                                              <a href="hapuskeranjang.php?id=<?php echo $id_padi ?>" class="btn btn-danger">Hapus</a>
                                            </td>
                                        </tr>
                                ...
                                <a href="checkout.php" class="btn btn-success"style="margin-left:670px">Lanjutkan</a>
