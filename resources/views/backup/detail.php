...
<strong>Nama Pelanggan : <?php echo $data['nama_depan'] ?></strong>
<strong><?php echo $data['nama_belakang']; ?></strong> <br><br>
<p>Email  : <?php echo $data['email']; ?><br>
   ...
   Status Pembayaran : <?php echo ($data['status_pembayaran']); ?>
 </p>
